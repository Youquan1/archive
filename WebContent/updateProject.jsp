            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12">
                            <!-- PAGE CONTENT BEGINS -->
                            <form role="form" class="form-horizontal" action="/UpdateProjectServlet" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    <input type="text" class="col-xs-8" placeholder="项目名称" id="form-field-1" name="projectName" required value="${pro.projectName }"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-10">
                                    ...
                                    <option <c:if test="${pro.categoryId==1 }">selected="selected"</c:if> value="1">城市设计<option>
                                    <option <c:if test="${pro.categoryId==2 }">selected="selected"</c:if> value="2">规划研究<option>
                                    <option <c:if test="${pro.categoryId==3 }">selected="selected"</c:if> value="3">专项规划<option>
                                    <option <c:if test="${pro.categoryId==4 }">selected="selected"</c:if> value="4">村镇规划<option>
                                    <option <c:if test="${pro.categoryId==5 }">selected="selected"</c:if> value="5">景观规划<option>
                                    </select>
                                </div>
                            </div>
                            <div class="space-4">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="text" id="Text12" name="proArea" value="${pro.proArea }"/>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">合同编号 </span>
                                                        <input class="form-control" type="text" id="Text2" name="proDocNo" value="${pro.proDocNo }"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="space-4">
                                            ...
                                            <div class="row">
                                                        <div class="col-xs-6">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" type="text" id="Text8" name="proScope" value="${pro.proScope }"/>
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" type="text" id="Text9" name="proPopulation" value="${pro.proPopulation }"/>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="text" id="Text3" name="proHead" value="${pro.proHead }"/>
                                                    </div>
                                                </div>
                                                <div class="col-xs-4">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">立项时间 </span>
                                                        <input class="form-control" type="text" id="Text19" placeholder="4位年份" name="proYear" value="${pro.proYear }"/>
                                                    </div>
                                                </div>
                                                <div class="col-xs-4">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">归档年度 </span>
                                                        <input class="form-control" type="text" id="Text1" placeholder="4位年份" name="proArcYear" value="${pro.proArcYear }"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="space-4">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="text" id="Text7" name="proAwardYear" value="${pro.proAwardYear }"/>
                                                    </div>
                                                </div>
                                                <div class="col-xs-4">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">颁奖等级 </span>
                                                        <input class="form-control" type="text" id="Text10" name="proAwardLeavel" value="${pro.proAwardLeavel }"/>
                                                    </div>
                                                </div>
                                                <div class="col-xs-4">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">颁奖单位 </span>
                                                        <input class="form-control" type="text" id="Text11" name="proAwardOrg" value="${pro.proAwardOrg }"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-8">
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">项目地域 </span>
                                                        <input class="form-control" type="text" id="Text13" name="appraiseArea" value="${pro.appraiseArea}"/>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon" title="项目负责人">项目负责人 </span>
                                                        <input class="form-control" type="text" id="Text5" name="appraiseHead" value="${pro.appraiseHead }"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="space-4">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">合同编号 </span>
                                                        <input class="form-control" type="text" id="Text4" name="appraiseDocNum" value="${pro.appraiseDocNum }"/>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">项目主持人 </span>
                                                        <input class="form-control" type="text" id="Text6" name="appraisePreside" value="${pro.appraisePreside }"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="space-4">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-4">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">颁奖年份 </span>
                                                        <input class="form-control" type="text" id="Text14" name="appraiseAwardYear" value="${pro.appraiseAwardYear }"/>
                                                    </div>
                                                </div>
                                                <div class="col-xs-4">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">颁奖等级 </span>
                                                        <input class="form-control" type="text" id="Text15" name="appraiseAwardLeavel" value="${pro.appraiseAwardLeavel }"/>
                                                    </div>
                                                </div>
                                                <div class="col-xs-4">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">颁奖单位 </span>
                                                        <input class="form-control" type="text" id="Text16" name="appraiseAwardOrg" value="${pro.appraiseAwardOrg }"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="text" id="Text17" name="subjectName" value="${pro.subjectName }"/>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">课题主持人 </span>
                                                        <input class="form-control" type="text" id="Text18" name="subjectHost" value="${pro.subjectHost }"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
