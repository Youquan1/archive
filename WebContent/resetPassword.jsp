	...
	<div class="main-container" id="main-container">
		<div class="main-container-inner">
			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						<form role="form" class="form-horizontal" action="/ResetOtherPasswordServlet" method="post" id="resetPWform" >
							...
							<div class="form-group">
								...
								<div class="col-xs-10">
									...
									<span style="color:red;margin-left:5px;">${WrongOriginPW}</span>
								</div>
							</div>
